...
Objectif : Créer un test automatisé permettant de contrôler que le mail "résultat" reçu de la part de "contact@hightest.nc" suite à la réalisation d'un test ISTQB Foundation en français (réussi à 100 %) sur le site de Hightest indique bien 100 % de bonnes réponses.
